...
namespace Deliveries
{
    class TransportCompany
    {
        ...
        {
            this.myDeliverables = this.myDeliverables.OrderBy(Deliverable => Deliverable.Buyer.Name).ToList();
        }
        ...
        {
            this.myDeliverables = this.myDeliverables.OrderBy(Deliverable => Deliverable.ID).ToList();
        }
        ...
        public void SortByAddress()
        {
            ...
            myDeliverables.Sort(new HouseNumberComparer());
        }
